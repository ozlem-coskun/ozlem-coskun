...
#result= len(result) #kaç tane?

#result=re.split() metodu
#ressult=re.split(" ",str)
...
result = re.findall("programlama$",str)
result = re.findall("programlamaa$",str)
...
"""
#w3schools ya da python.org dan ihtiycın olanları bulabilirsin